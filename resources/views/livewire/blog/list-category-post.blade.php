<div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
    ...
    <h2 class="text-glow text-4xl tracking-tight text-pretty text-gray-800 sm:text-5xl dark:text-gray-200 mb-5 font-heading">{{ $category->name }}</h2>
    {{-- <h2 class="mb-2 text-3xl text-gray-800 dark:text-gray-200">{{ $category->name }}</h2> --}}

    @if ($category->description)
        <p class="text-xl text-gray-500 dark:text-gray-400 font-subtext">{{ $category->description }}</p>
    @endif
