        ...
        <div class="my-6">
            ...
            <div class="grid grid-cols-1 mt-6 gap-x-6 gap-y-10 md:grid-cols-2 xl:grid-cols-3 xl:gap-x-8 min-h-[200px] content-container">
                @forelse ($sold_items as $sold_item)
                    ...
                    <div class="relative lazy-card" id="sold-item-{{ $sold_item->id }}">
                        <div class="h-25-vh *:bg-transparent min-h-[300px] min-w-[300px] skeleton-loader">
                            <div wire:loading.remove class="mb-4 h-full w-full text-center text-3xl content-center">
                                <x-loading-indicator
                                    :loader_color_bg="'fill-gray-200'"
                                    :loader_color_spin="'fill-gray-200'"
                                    :showText="true"
                        ...
                        <img src="{{ $sold_item->image_location ? asset('/storage/' .$sold_item->image_location) : 'https://tailwindui.com/plus/img/ecommerce-images/product-page-01-related-product-01.jpg' }}" class="object-cover w-full transition duration-300 bg-transparent rounded-md aspect-square group-hover:opacity-75 lg:aspect-auto lg:h-80 hover:scale-105 hidden actual-content" alt="Sold item image" title="Sold item image" loading="lazy" />
